...
class UNet3DBN(TrainableLayer):
    ...
    def __init__(self,
                 ...
                 name='UNet',
                 num_outputs=2):
        super(UNet3DBN, self).__init__(name=name)
    ...
    def layer_op(self, images, is_training=True, layer_id=-1, **unused_kwargs):
        ...
        for i in range(0,self.num_outputs):
            conv_op = ConvolutionalLayer(n_output_chns=self.num_classes,
                kernel_size=1,
                w_initializer=self.initializers['w'],
                w_regularizer=self.regularizers['w'],
                acti_func=None,
                ...
                with_bn=False,
                with_bias=True)
            output_conv_op.append(conv_op)
            final_output_tensor.append(output_conv_op[i](output_tensor, is_training))
            print(output_conv_op[i])

        return tf.concat(final_output_tensor, -1)
