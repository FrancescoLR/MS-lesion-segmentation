...
class UNet3D_3levels(TrainableLayer):
    """
    reimplementation of 3D U-net
      Çiçek et al., "3D U-Net: Learning dense Volumetric segmentation from
      sparse annotation", MICCAI '16 with only three resolution levels
    """
    ...
    def __init__(self,
                 ...
                 acti_func='prelu',
                 name='UNet'):
        super(UNet3D_3levels, self).__init__(name=name)

        self.n_features = [32, 64, 128, 256]
        self.acti_func = acti_func
    ...
    def layer_op(self, images, is_training=True, layer_id=-1, **unused_kwargs):
        ...
        block_layer = UNetBlock('UPSAMPLE',
                                ...
                                acti_func=self.acti_func,
                                name='u2')
        up_2, _ = block_layer(pool_2, is_training)
        print(block_layer)
        ...
        block_layer = UNetBlock('UPSAMPLE',
                                ...
                                acti_func=self.acti_func,
                                name='u1')
        crop_layer = CropLayer(border=4, name='crop-32')
        concat_2 = ElementwiseLayer('CONCAT')(crop_layer(conv_2), up_2)
        up_1, _ = block_layer(concat_2, is_training)
        print(block_layer)
        ...
        block_layer = UNetBlock('NONE',
                                ...
                                acti_func=self.acti_func,
                                name='u0')
        crop_layer = CropLayer(border=16, name='crop-80')
        concat_1 = ElementwiseLayer('CONCAT')(crop_layer(conv_1), up_1)
        print(block_layer)
